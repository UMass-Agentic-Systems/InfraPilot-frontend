  ...
  'app-1': {
    ...
    tiers: {
      frontend: {
        ...
        resources: { cpuUsage: 35, memoryUsage: 42 },
  ...
  'app-2': {
    ...
    tiers: {
      frontend: {
        ...
        tech: ['Next.js', 'Nginx'],
        pods: { running: 2, pending: 0, error: 0 },
        resources: { cpuUsage: 28, memoryUsage: 38 },
        service: { type: 'LoadBalancer', port: 443 },
      },
      backend: {
        name: 'Backend',
